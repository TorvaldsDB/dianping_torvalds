...
export const types = {
  ...
  // 获取超值特惠请求
  FETCH_DISCOUNTS_REQUEST: 'HOME_FETCH_DISCOUNTS_REQUEST',
  // 获取超值特惠请求成功
  FETCH_DISCOUNTS_SUCCESS: 'HOME_FETCH_DISCOUNTS_SUCCESS',
  // 获取超值特惠请求失败
  FETCH_DISCOUNTS_FAILURE: 'HOME_FETCH_DISCOUNTS_FAILURE'
};
